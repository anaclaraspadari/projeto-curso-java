...
public class SellerDaoJDBC implements SellerDao{
    ...
    public List<Seller> findByDepartment(Department department){
        ...
        ResultSet rs=null;
        try{
            st=conn.prepareStatement("select seller.*, department.name as depName from seller inner join department on seller.department=department.id where seller.id=? order by name");
    ...
    public List<Seller> findAll(){
        ...
        ResultSet rs=null;
        try{
            st=conn.prepareStatement("select seller.*, department.name as depName from seller inner join department on seller.department=department.id order by name");
